...
export function Omnibar() {
  ...
  const { setDivision, setCategory } = useAppStore();

  const handleNavigate = (
    app: string,
    cat: "core" | "infrastructure" | "business",
  ) => {
    setDivision(app);
    setCategory(cat);
  };

  // ... (rest of the component logic using handleNavigate)
  const results = search
    ? [
        ...
        },
        {
          id: 2,
          type: "Ticket",
          title: "Network Delay in Floor 4",
          sub: "#T-402 - Open",
          app: "pilot",
          icon: Ticket,
        },
        ...
        },
        {
          id: 5,
          type: "Product",
          title: "SENT-CORE-NODE",
          sub: "Stock: 42 - Aisle 4",
          app: "stock",
          icon: Package,
        },
        // Verification case for XSS payload
        {
          id: 6,
          type: "Invoice",
          title: "<script>alert('XSS')</script> Payload",
          sub: "Adversarial Test Case",
          app: "erp",
          icon: ShieldAlert,
        },
                      ...
                      runCommand(() => {
                        const cat = [
                          ...
                          : [
                            ...
                            ? "infrastructure"
                            : "core";
                        handleNavigate(res.app as any, cat as any);
                      })
                    }
              ...
              <>
                <Command.Group heading="Infrastructure (MSP)">
                  <Command.Item
                    onSelect={() =>
                      runCommand(() =>
                        handleNavigate("pulse", "infrastructure"),
                      )
                    }
                    className="flex cursor-pointer select-none items-center rounded-lg px-3 py-2.5 text-sm outline-none aria-selected:bg-primary aria-selected:text-primary-foreground transition-all gap-3"
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[10px] opacity-70">
                        Real-time RMM & Telemetry Ingest
                      </span>
                    </div>
                  </Command.Item>
                  <Command.Item
                    onSelect={() =>
                      runCommand(() =>
                        handleNavigate("nexus", "infrastructure"),
                      )
                    }
                    className="flex cursor-pointer select-none items-center rounded-lg px-3 py-2.5 text-sm outline-none aria-selected:bg-primary aria-selected:text-primary-foreground transition-all gap-3"
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[10px] opacity-70">
                        Documentation, Asset Graph & Vault
                      </span>
                    </div>
                  </Command.Item>
                  <Command.Item
                    onSelect={() =>
                      runCommand(() =>
                        handleNavigate("optic", "infrastructure"),
                      )
                    }
                    className="flex cursor-pointer select-none items-center rounded-lg px-3 py-2.5 text-sm outline-none aria-selected:bg-primary aria-selected:text-primary-foreground transition-all gap-3"
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[10px] opacity-70">
                        NVR Surveillance & AI Inference
                      </span>
                    </div>
                  </Command.Item>
                  <Command.Item
                    onSelect={() =>
                      runCommand(() => handleNavigate("grid", "infrastructure"))
                    }
                    className="flex cursor-pointer select-none items-center rounded-lg px-3 py-2.5 text-sm outline-none aria-selected:bg-primary aria-selected:text-primary-foreground transition-all gap-3"
                  >
                  ...
                  <Command.Item
                    onSelect={() =>
                      runCommand(() =>
                        handleNavigate("pilot", "infrastructure"),
                      )
                    }
                    className="flex cursor-pointer select-none items-center rounded-lg px-3 py-2.5 text-sm outline-none aria-selected:bg-primary aria-selected:text-primary-foreground transition-all gap-3"
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[10px] opacity-70">
                        ITSM Cockpit & Professional Services
                      </span>
                    </div>
                  </Command.Item>
                  <Command.Item
                    onSelect={() =>
                      runCommand(() =>
                        handleNavigate("horizon", "infrastructure"),
                      )
                    }
                    className="flex cursor-pointer select-none items-center rounded-lg px-3 py-2.5 text-sm outline-none aria-selected:bg-primary aria-selected:text-primary-foreground transition-all gap-3"
                  >
                  ...
                  <Command.Item
                    onSelect={() =>
                      runCommand(() =>
                        handleNavigate("control", "infrastructure"),
                      )
                    }
                    className="flex cursor-pointer select-none items-center rounded-lg px-3 py-2.5 text-sm outline-none aria-selected:bg-primary aria-selected:text-primary-foreground transition-all gap-3"
                  >
                  ...
                  <Command.Item
                    onSelect={() =>
                      runCommand(() => handleNavigate("wave", "infrastructure"))
                    }
                    className="flex cursor-pointer select-none items-center rounded-lg px-3 py-2.5 text-sm outline-none aria-selected:bg-primary aria-selected:text-primary-foreground transition-all gap-3"
                  >
                    <Activity className="h-4 w-4" />
                ...
                <Command.Group heading="Business (ERP)">
                  <Command.Item
                    onSelect={() =>
                      runCommand(() => handleNavigate("people", "business"))
                    }
                    className="flex cursor-pointer select-none items-center rounded-lg px-3 py-2.5 text-sm outline-none aria-selected:bg-primary aria-selected:text-primary-foreground transition-all gap-3"
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[10px] opacity-70">
                        HRIS, Payroll & Succession Planning
                      </span>
                    </div>
                  </Command.Item>
                  <Command.Item
                    onSelect={() =>
                      runCommand(() => handleNavigate("erp", "business"))
                    }
                    className="flex cursor-pointer select-none items-center rounded-lg px-3 py-2.5 text-sm outline-none aria-selected:bg-primary aria-selected:text-primary-foreground transition-all gap-3"
                  >
                  ...
                  <Command.Item
                    onSelect={() =>
                      runCommand(() => handleNavigate("stock", "business"))
                    }
                    className="flex cursor-pointer select-none items-center rounded-lg px-3 py-2.5 text-sm outline-none aria-selected:bg-primary aria-selected:text-primary-foreground transition-all gap-3"
                  >
                  ...
                  <Command.Item
                    onSelect={() =>
                      runCommand(() => handleNavigate("kiosk", "business"))
                    }
                    className="flex cursor-pointer select-none items-center rounded-lg px-3 py-2.5 text-sm outline-none aria-selected:bg-primary aria-selected:text-primary-foreground transition-all gap-3"
                  >
                ...
                <Command.Group heading="Settings & Admin">
                  <Command.Item
                    onSelect={() =>
                      runCommand(() => handleNavigate("admin", "core"))
                    }
                    className="flex cursor-pointer select-none items-center rounded-lg px-3 py-2.5 text-sm outline-none aria-selected:bg-primary aria-selected:text-primary-foreground transition-all gap-3"
                  >
          ...
          <div className="flex items-center justify-between border-t px-4 py-2 text-[10px] text-muted-foreground bg-muted/30">
            <div className="flex gap-4">
              <span className="flex items-center gap-1">
                <kbd className="px-1 bg-muted rounded border shadow-sm font-sans">
                  ↑↓
                </kbd>{" "}
                Navigate
              </span>

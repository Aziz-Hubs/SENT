...
* **Tech Engine:** Go-Sysinfo \+ TimescaleDB \+ Centrifugo.
...
* **SENTpeople (HR):** Employee lifecycle, succession planning (HiPo), and multi-currency Gross-to-Net payroll. (Maroto v2)  

...
type AssetQuery struct {
	...
	withType         *AssetTypeQuery
	withHostedAt     *AssetQuery
	withHostedAssets *AssetQuery
	withDependencyOf *AssetQuery
	withDependsOn    *AssetQuery
	withOwner        *UserQuery
...
func (_q *AssetQuery) QueryType() *AssetTypeQuery {
...
// QueryHostedAt chains the current query on the "hosted_at" edge.
func (_q *AssetQuery) QueryHostedAt() *AssetQuery {
...
// QueryHostedAssets chains the current query on the "hosted_assets" edge.
func (_q *AssetQuery) QueryHostedAssets() *AssetQuery {
	query := (&AssetClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
// QueryDependencyOf chains the current query on the "dependency_of" edge.
func (_q *AssetQuery) QueryDependencyOf() *AssetQuery {
	query := (&AssetClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *AssetQuery) QueryDependsOn() *AssetQuery {
	query := (&AssetClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *AssetQuery) QueryOwner() *UserQuery {
...
func (_q *AssetQuery) QueryCredentials() *CredentialQuery {
...
func (_q *AssetQuery) QuerySops() *SOPQuery {
...
func (_q *AssetQuery) QueryTickets() *TicketQuery {
...
func (_q *AssetQuery) QueryProduct() *ProductQuery {
...
func (_q *AssetQuery) Clone() *AssetQuery {
	...
	return &AssetQuery{
		...
		withHostedAt:     _q.withHostedAt.Clone(),
		withHostedAssets: _q.withHostedAssets.Clone(),
		withDependencyOf: _q.withDependencyOf.Clone(),
...
func (_q *AssetQuery) WithType(opts ...func(*AssetTypeQuery)) *AssetQuery {
	query := (&AssetTypeClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithHostedAt tells the query-builder to eager-load the nodes that are connected to
// the "hosted_at" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *AssetQuery) WithHostedAt(opts ...func(*AssetQuery)) *AssetQuery {
	query := (&AssetClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withHostedAt = query
	return _q
}

// WithHostedAssets tells the query-builder to eager-load the nodes that are connected to
// the "hosted_assets" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *AssetQuery) WithHostedAssets(opts ...func(*AssetQuery)) *AssetQuery {
	query := (&AssetClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withHostedAssets = query
	return _q
}

// WithDependencyOf tells the query-builder to eager-load the nodes that are connected to
// the "dependency_of" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *AssetQuery) WithDependencyOf(opts ...func(*AssetQuery)) *AssetQuery {
	query := (&AssetClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withDependencyOf = query
	return _q
}
...
func (_q *AssetQuery) WithDependsOn(opts ...func(*AssetQuery)) *AssetQuery {
	query := (&AssetClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AssetQuery) WithOwner(opts ...func(*UserQuery)) *AssetQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AssetQuery) WithCredentials(opts ...func(*CredentialQuery)) *AssetQuery {
	query := (&CredentialClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AssetQuery) WithSops(opts ...func(*SOPQuery)) *AssetQuery {
	query := (&SOPClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AssetQuery) WithTickets(opts ...func(*TicketQuery)) *AssetQuery {
	query := (&TicketClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AssetQuery) WithProduct(opts ...func(*ProductQuery)) *AssetQuery {
	query := (&ProductClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AssetQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Asset, error) {
	var (
		...
		loadedTypes = [11]bool{
			...
			_q.withType != nil,
			_q.withHostedAt != nil,
			_q.withHostedAssets != nil,
			_q.withDependencyOf != nil,
	...
	if _q.withTenant != nil || _q.withType != nil || _q.withHostedAt != nil || _q.withOwner != nil || _q.withProduct != nil {
		withFKs = true
	}
	if withFKs {
	...
	if query := _q.withType; query != nil {
		if err := _q.loadType(ctx, query, nodes, nil,
			func(n *Asset, e *AssetType) { n.Edges.Type = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withHostedAt; query != nil {
		if err := _q.loadHostedAt(ctx, query, nodes, nil,
			func(n *Asset, e *Asset) { n.Edges.HostedAt = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withHostedAssets; query != nil {
		if err := _q.loadHostedAssets(ctx, query, nodes,
			func(n *Asset) { n.Edges.HostedAssets = []*Asset{} },
			func(n *Asset, e *Asset) { n.Edges.HostedAssets = append(n.Edges.HostedAssets, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withDependencyOf; query != nil {
		if err := _q.loadDependencyOf(ctx, query, nodes,
			func(n *Asset) { n.Edges.DependencyOf = []*Asset{} },
			func(n *Asset, e *Asset) { n.Edges.DependencyOf = append(n.Edges.DependencyOf, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withDependsOn; query != nil {
		if err := _q.loadDependsOn(ctx, query, nodes,
			func(n *Asset) { n.Edges.DependsOn = []*Asset{} },
			func(n *Asset, e *Asset) { n.Edges.DependsOn = append(n.Edges.DependsOn, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withOwner; query != nil {
		if err := _q.loadOwner(ctx, query, nodes, nil,
			func(n *Asset, e *User) { n.Edges.Owner = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withSops; query != nil {
		if err := _q.loadSops(ctx, query, nodes,
			func(n *Asset) { n.Edges.Sops = []*SOP{} },
			func(n *Asset, e *SOP) { n.Edges.Sops = append(n.Edges.Sops, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTickets; query != nil {
		if err := _q.loadTickets(ctx, query, nodes,
			func(n *Asset) { n.Edges.Tickets = []*Ticket{} },
			func(n *Asset, e *Ticket) { n.Edges.Tickets = append(n.Edges.Tickets, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withProduct; query != nil {
		if err := _q.loadProduct(ctx, query, nodes, nil,
			func(n *Asset, e *Product) { n.Edges.Product = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AssetQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Tenant)) error {
	...
	for i := range nodes {
		if nodes[i].tenant_assets == nil {
			continue
		}
		fk := *nodes[i].tenant_assets
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "tenant_assets" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *AssetQuery) loadType(ctx context.Context, query *AssetTypeQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *AssetType)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Asset)
	for i := range nodes {
		if nodes[i].asset_type_assets == nil {
			continue
		}
		fk := *nodes[i].asset_type_assets
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
	...
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "asset_type_assets" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *AssetQuery) loadHostedAt(ctx context.Context, query *AssetQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Asset)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Asset)
	for i := range nodes {
		if nodes[i].asset_hosted_assets == nil {
			continue
		}
		fk := *nodes[i].asset_hosted_assets
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
	...
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "asset_hosted_assets" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *AssetQuery) loadHostedAssets(ctx context.Context, query *AssetQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Asset)) error {
	...
	query.Where(predicate.Asset(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(asset.HostedAssetsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.asset_hosted_assets
		if fk == nil {
			return fmt.Errorf(`foreign-key "asset_hosted_assets" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "asset_hosted_assets" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *AssetQuery) loadDependencyOf(ctx context.Context, query *AssetQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Asset)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(asset.DependencyOfTable)
		s.Join(joinT).On(s.C(asset.FieldID), joinT.C(asset.DependencyOfPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(asset.DependencyOfPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(asset.DependencyOfPrimaryKey[1]))
	...
	for _, n := range neighbors {
		nodes, ok := nids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected "dependency_of" node returned %v`, n.ID)
		}
		for kn := range nodes {
			assign(kn, n)
		}
...
func (_q *AssetQuery) loadDependsOn(ctx context.Context, query *AssetQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Asset)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*Asset)
	nids := make(map[int]map[*Asset]struct{})
	for i, node := range nodes {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(asset.DependsOnTable)
		s.Join(joinT).On(s.C(asset.FieldID), joinT.C(asset.DependsOnPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(asset.DependsOnPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(asset.DependsOnPrimaryKey[0]))
		s.AppendSelect(columns...)
		s.SetDistinct(false)
	})
	if err := query.prepareQuery(ctx); err != nil {
...
func (_q *AssetQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *User)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Asset)
	for i := range nodes {
		if nodes[i].user_owned_assets == nil {
			continue
		}
		fk := *nodes[i].user_owned_assets
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
	...
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "user_owned_assets" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *AssetQuery) loadCredentials(ctx context.Context, query *CredentialQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Credential)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Asset)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *AssetQuery) loadSops(ctx context.Context, query *SOPQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *SOP)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Asset)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.SOP(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(asset.SopsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.asset_sops
		if fk == nil {
			return fmt.Errorf(`foreign-key "asset_sops" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "asset_sops" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *AssetQuery) loadTickets(ctx context.Context, query *TicketQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Ticket)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Asset)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.Ticket(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(asset.TicketsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.asset_tickets
		if fk == nil {
			return fmt.Errorf(`foreign-key "asset_tickets" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "asset_tickets" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *AssetQuery) loadProduct(ctx context.Context, query *ProductQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Product)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Asset)
	for i := range nodes {
		if nodes[i].asset_product == nil {
			continue
		}
		fk := *nodes[i].asset_product
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
	...
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "asset_product" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
